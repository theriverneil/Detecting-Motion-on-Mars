...
for i=1:length(Images)
    for j=(i+1):length(Images)
        ...
        T = affine2d;
        I2_transform = imregtform(I2_up(2500:3860,1:800), I1_up(2500:3860,1:800), 'similarity', optimizer, metric,'DisplayOptimization',true,'InitialTransformation', T, 'PyramidLevels', 1);
...
% I1 = imread('../../../Insight Images/PNG/Sol 74/_mars.nasa.gov_insight-raw-images_surface_sol_0074_idc_D000M0074_603100395EDR_F0000_2695M_.png');
...
% 
% figure
% imagesc(imDiff_actual_rescaled(2500:3860,1:800) + 0.15);
% colorbar
...
% colormap(colorMap);
% 
% I2_up_transformed = imwarp(I2_up(2500:3860,1:800),I2_transform,'OutputView',imref2d(size(I1_up(2500:3860,1:800))));
% imDiff = int8(I2_up_transformed) - int8(I2_up(2500:3860,1:800));
% imDiff = rescale(imDiff,-1,1);
% figure
% imagesc(imDiff - 0.815);
% colorbar
% greenColorMap = [zeros(1, 132), linspace(0, 1, 124)];
% redColorMap = [linspace(1, 0, 124), zeros(1, 132)];
% colorMap = [redColorMap; greenColorMap; zeros(1, 256)]';
