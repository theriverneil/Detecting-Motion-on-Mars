...
T = affine2d;
I2_up_transformed = imregister(I2_up, I1_up, 'rigid', optimizer, metric,'DisplayOptimization',true,'InitialTransformation', T, 'PyramidLevels', 1);
save imRegTest.mat
% load imRegTest.mat
% imshow(I2_up_transformed)
...
% colormap(colorMap);
% 
% imDiff = int8(I1_up) - int8(I2_up_transformed);
% imDiff = rescale(imDiff,-1,1);
% figure
% imagesc(imDiff(1400:2400,:) - 0.02);
% colorbar
% greenColorMap = [zeros(1, 132), linspace(0, 1, 124)];
% redColorMap = [linspace(1, 0, 124), zeros(1, 132)];
% colorMap = [redColorMap; greenColorMap; zeros(1, 256)]';
