...
for i=1:length(Images)
    for j=(i+1):length(Images)
        tic
        I1 = imread(sprintf('../../../Insight Images/PNG/Sol 97/%s.png', Images(j)));
        I2 = imread(sprintf('../../../Insight Images/PNG/Sol 97/%s.png', Images(i)));
        I1 = rgb2gray(I1);
        I2 = rgb2gray(I2);
...
% I1 = imread('../../../Insight Images/PNG/Sol 97/_mars.nasa.gov_insight-raw-images_surface_sol_0097_idc_D000M0097_605136323EDR_F0000_2696M_.png');
% I2 = imread('../../../Insight Images/PNG/Sol 97/_mars.nasa.gov_insight-raw-images_surface_sol_0097_idc_D000M0097_605136276EDR_F0000_2695M_.png');
% I1 = rgb2gray(I1);
% I2 = rgb2gray(I2);
% [I1_up, I2_up] = Upsample(I1, I2);
% figure
...
% 
% figure
% imagesc(imDiff_actual_rescaled(1600:3200,1:1150) + 0.4);
% colorbar
